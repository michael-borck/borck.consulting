...
- Exploring unfamiliar territory where the firm needs to get up to speed quickly
- Generating boilerplate for matters or formats you rarely deal with
- Stress-testing arguments and positions
- Brainstorming approaches before committing to one
- Translating technical content into plain language for clients
- Processing or summarising volumes of material that would take hours by hand
- Drafting first-pass communications you will substantially rewrite anyway
...
- Partner review time on a draft no one needed
- Insurance exposure when an AI-generated draft slips through unchecked
- Junior staff who never built the underlying capability because the AI did the work that would have taught them
- Leadership attention spent on AI vendor evaluations rather than on the practice
