---
title: "The Question Architect"
description: "Expertise in the age of AI — and why your firm's value is moving from the answer to the inquiry"
slug: question-architect
order: 11
...
- **Thomas Bayes (1763)** — the mathematical foundations of how machines "learn" from data are rooted in probability theory proposed by Bayes in the mid-eighteenth century. Much of today's machine learning still relies on his theorems.
- **John McCarthy (1956)** — the term "Artificial Intelligence" was coined by McCarthy for a research workshop he organised. He collaborated with Claude Shannon, whose information theory is foundational enough that Anthropic named its flagship model in his honour.
- **Established curricula** — by the 1970s, Stanford, MIT, CMU, and the University of Edinburgh had codified AI and machine learning into their degree programmes.
...
| Generic AI knowledge | Applied professional expertise |
|---|---|
| Understanding how a chatbot works in general | Designing how AI is allowed to touch a privileged client matter |
| Knowing prompts can be structured with frameworks | Building prompt patterns that match the firm's letter standards and risk appetite |
| Reading about hallucination | Knowing which kinds of citations and references your AI workflow must double-check before they go out |
| Knowing AI can summarise documents | Knowing which documents in your matter file should never be summarised by AI in the first place |
...
- **Assert domain context.** Apply AI to your specific area of practice. Generic prompts produce generic output.
- **Respect the history.** Recognise that AI is not magic — it is mathematics with marketing — and treat it accordingly.
- **Architect the outcome.** Focus on how outputs solve a real client problem, not on operating the tool itself.
